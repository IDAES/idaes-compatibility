...
fname = os.path.join(currdir, "requil.json")
...
def generate_baseline():
    ...
    spec.add_sampled_input("fs.unit.inlet.conc_mol_comp[0,NaOH]", lower=40, upper=120)
    spec.add_sampled_input("fs.unit.inlet.conc_mol_comp[0,EthylAcetate]", lower=40, upper=120)
    spec.add_sampled_input("fs.unit.inlet.conc_mol_comp[0,SodiumAcetate]", lower=1e-8, upper=30)
    spec.add_sampled_input("fs.unit.inlet.conc_mol_comp[0,Ethanol]", lower=1e-8, upper=30)
